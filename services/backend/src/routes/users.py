...
async def create_user(user: Employee) -> Employee:
...
@router.get(
    "/users/whoami", response_model=Employee, dependencies=[Depends(get_current_user)]
)
...
async def delete_user(
    user_id: int, current_user: Employee = Depends(get_current_user)
) -> Status:
